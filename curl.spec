...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607564944
...
cp %{_builddir}/curl-7.74.0/COPYING %{buildroot}/usr/share/package-licenses/curl/0a31fbdd5090bd461236bca4b1a86c79fd244d7a
pushd ../build32/
%make_install32
